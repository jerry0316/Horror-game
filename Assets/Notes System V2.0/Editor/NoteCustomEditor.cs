...
namespace NoteSystem
{
    ...
    public class NoteCustomEditor : Editor
    {
        ...
        SerializedProperty overlayFontType;
        SerializedProperty overlayFontStyle;
        ...
        void OnEnable()
        {
            ...
            overlayFontType = serializedObject.FindProperty(nameof(overlayFontType));
            overlayFontStyle = serializedObject.FindProperty(nameof(overlayFontStyle));
            ...
            {              
                ...
                flipTextCustomisationGroup = EditorGUILayout.BeginFoldoutHeaderGroup(flipTextCustomisationGroup, "Overlay Font Settings");
                {
                    if (flipTextCustomisationGroup)
                    {
                        ...
                        EditorGUILayout.PropertyField(overlayFontType);
