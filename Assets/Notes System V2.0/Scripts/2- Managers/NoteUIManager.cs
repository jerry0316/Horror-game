...
namespace NoteSystem
{
    public class NoteUIManager : MonoBehaviour
    {
        ...
        public void InitialiseMainNote(Sprite pageImage, Vector2 pageScale, string pageText, Vector2 mainTextAreaScale, int mainTextSize, FontStyle mainFontStyle, Font mainFontType, 
            Color mainFontColor)
        {
            DisplayPage(pageImage);
            DisableNoteDisplay(true);
            ...
            noteTextUI.fontStyle = mainFontStyle;
            noteTextUI.font = mainFontType;
            noteTextUI.color = mainFontColor;
        }

        public void InitialiseOverlay(Color overlayBGColor, Vector2 overlayTextAreaScale, string noteText, int overlayTextSize, Font overlayFontType, FontStyle overlayFontStyle, 
            Color overlayFontColor, Vector2 overlayTextBGScale)
        {
            ...
            overlayTextUI.font = overlayFontType;
            overlayTextUI.fontStyle = overlayFontStyle;
